      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-4xl justify-center gap-6 sm:grid-cols-1 lg:max-w-5xl lg:grid-cols-3">
          {painPoints.map((point, index) => {
            ...
            return (
              <div key={index} className="flex flex-col items-center text-center gap-4 p-6 bg-secondary/30 rounded-xl shadow-md border-2 border-transparent hover:border-primary/50 transition-all">
