    ...
    <section id="purpose" className="w-full py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <Button asChild size="lg" className="text-base md:text-lg rounded-full font-bold bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg w-full sm:w-auto">
